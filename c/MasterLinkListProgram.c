...
1. Append element at the end of linked list
2. Concatenate two linked lists
3. Free all nodes in a linked list
4. Reverse a linked list
5. Delete last element of linked list
6. Delete nth element of linked list
7. Combine two ordered linked list into single ordered link list
8. Find union of two linked lists
9. Find intersection of two linked lists
10. Insert after nth element in a linked list
11. Delete every second element of a linked list
12. Place elements in order in a linked list
13. Calculate sum of data of a linked list
14. calculate number of elements in a linked list
15. Make second copy of a linked list
16. Move node forward to nth positions in a linked list
